/**
 * DeactivateDeactivateRemoteUnlock Tool
 *
 * Disable remote unlock for the specified deactivate remote unlock.
 *
 * @category product/access
 * @operationId putDeactivateRemoteUnlockViewV1
 * @method PUT
 * @path /access/v1/access_users/user/remote_unlock/deactivate
...
/**
 * Input parameters for deactivateDeactivateRemoteUnlock
 */
const DeactivateDeactivateRemoteUnlockInputSchema = z.object({
  /** Path parameters */
  query: z.object({
...
type DeactivateDeactivateRemoteUnlockInput = z.infer<typeof DeactivateDeactivateRemoteUnlockInputSchema>;
...
/**
 * Output schema for deactivateDeactivateRemoteUnlock
 * OK
 */
const DeactivateDeactivateRemoteUnlockOutputSchema = z.object({
...
type DeactivateDeactivateRemoteUnlockOutput = z.infer<typeof DeactivateDeactivateRemoteUnlockOutputSchema>;
 ...
 * @returns OK
 */
export async function deactivateDeactivateRemoteUnlock(
  input: DeactivateDeactivateRemoteUnlockInput
): Promise<APIResponse<DeactivateDeactivateRemoteUnlockOutput>> {
  // Validate input
  const validated = DeactivateDeactivateRemoteUnlockInputSchema.parse(input);

  // Build path with parameters
  const path = '/access/v1/access_users/user/remote_unlock/deactivate';
  ...
  // Make API request
  const response = await callVerkadaAPI<DeactivateDeactivateRemoteUnlockOutput>({
    method: 'PUT',
    path: fullPath,
  });
  ...
  if (response.success && response.data) {
    try {
      response.data = DeactivateDeactivateRemoteUnlockOutputSchema.parse(response.data);
    } catch (error) {
 ...
 */
export const deactivateDeactivateRemoteUnlockMetadata = {
  name: 'deactivate_deactivate_remote_unlock',
  description: `Disable remote unlock for the specified deactivate remote unlock.`,
  inputSchema: DeactivateDeactivateRemoteUnlockInputSchema,
  outputSchema: DeactivateDeactivateRemoteUnlockOutputSchema,
  category: 'product/access',
  operationId: 'putDeactivateRemoteUnlockViewV1',
  method: 'PUT' as const,
  path: '/access/v1/access_users/user/remote_unlock/deactivate',
