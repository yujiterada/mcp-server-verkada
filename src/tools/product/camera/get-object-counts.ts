...
const GetObjectCountsOutputSchema = z.object({
  ...
  /** Object counts */
  object_counts: z.array(z.object({ detected_time: z.number().int().nullable().optional(), people_count: z.number().int().nullable().optional(), vehicle_count: z.number().int().nullable().optional() })).nullable(),
});
