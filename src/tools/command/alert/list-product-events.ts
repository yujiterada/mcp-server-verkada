...
const ListProductEventsOutputSchema = z.object({
  ...
  /** List of events */
  items: z.array(z.union([z.object({ device_id: z.string().nullable(), device_type: z.enum(['camera']).nullable().optional(), event_id: z.string().nullable(), event_info: z.object({ crowd_threshold: z.number().int().nullable().optional(), detected_objects: z.array(z.string()).nullable().optional(), event_description: z.string().nullable().optional(), license_plate_number: z.string().nullable().optional(), license_plate_state: z.string().nullable().optional(), location: z.string().nullable().optional(), location_lat: z.string().nullable().optional(), location_lon: z.string().nullable().optional(), person_label: z.string().nullable().optional(), rounded_inactivity_duration_mins: z.number().int().nullable().optional() }).nullable().optional(), event_type: z.string().nullable(), timestamp: z.string().nullable() }), z.object({ device_id: z.string().nullable(), device_type: z.enum(['sensor']).nullable().optional(), event_id: z.string().nullable(), event_info: z.object({ end_time: z.string().nullable().optional(), most_extreme_value: z.number().nullable().optional(), reading: z.string().nullable().optional(), threshold: z.number().nullable().optional() }).nullable().optional(), event_type: z.string().nullable(), timestamp: z.string().nullable() }), z.object({ device_id: z.string().nullable(), device_type: z.enum(['access_control']).nullable().optional(), event_id: z.string().nullable(), event_info: z.object({ accepted: z.boolean().nullable().optional(), access_controller_id: z.string().nullable().optional(), access_controller_name: z.string().nullable().optional(), aux_input_id: z.string().nullable().optional(), aux_input_name: z.string().nullable().optional(), building_id: z.string().nullable().optional(), building_name: z.string().nullable().optional(), direction: z.string().nullable().optional(), door_id: z.string().nullable().optional(), door_name: z.string().nullable().optional(), entity_id: z.string().nullable().optional(), entity_name: z.string().nullable().optional(), entity_type: z.string().nullable().optional(), floor_id: z.string().nullable().optional(), floor_name: z.string().nullable().optional(), floors: z.array(z.object({ door_id: z.string().nullable().optional(), floor_id: z.string().nullable().optional(), uuid: z.string().nullable().optional() })).nullable().optional(), granted: z.boolean().nullable().optional(), input_value: z.string().nullable().optional(), message: z.string().nullable().optional(), raw_card: z.string().nullable().optional(), scenario_info: z.object({ action: z.string().nullable().optional(), scenario: z.unknown().nullable().optional() }).nullable().optional(), user_info: z.object({ email: z.string().nullable().optional(), first_name: z.string().nullable().optional(), last_name: z.string().nullable().optional(), name: z.string().nullable().optional(), phone: z.string().nullable().optional(), user_id: z.string().nullable().optional() }).nullable().optional() }).nullable().optional(), event_type: z.string().nullable(), timestamp: z.string().nullable() }), z.object({ device_id: z.string().nullable(), device_type: z.enum(['intercom']).nullable().optional(), event_id: z.string().nullable(), event_info: z.object({ answered_by_name: z.string().nullable().optional(), answered_timestamp: z.string().nullable().optional(), device_name: z.string().nullable().optional(), end_timestamp: z.string().nullable().optional(), start_timestamp: z.string().nullable().optional() }).nullable().optional(), event_type: z.string().nullable(), timestamp: z.string().nullable() })])).nullable(),
});
